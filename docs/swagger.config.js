...
const swaggerDefinition = {
    ...
    info: {
        ...
        version: "1.0.0",
        description: "API para gestión de WhatsApp con flujos conversacionales y autenticación JWT",
        contact: {
    ...
    tags: [
        ...
        {
            name: "WhatsApp",
            description: "Endpoints para gestión de sesiones de WhatsApp (API original)",
        },
        {
            name: "WhatsApp Multitenant",
            description: "Endpoints para gestión de WhatsApp por shop (API multitenant)",
        },
        {
            name: "Flows",
        ...
        {
            name: "Admin",
            description: "Endpoints de administración del sistema (requiere rol ADMIN)",
        },
        {
            name: "Health",
